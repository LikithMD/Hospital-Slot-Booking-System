    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="container" id="container">
                <form action="a_bookview.php" method="POST">
                ...
                <?php
                    if(isset($_POST['view'])){
                        ...
                        $sql = "SELECT Tno,Dno,pno,Dtime FROM slotbook where Ddate='$dat'";
                        $result = mysqli_query($conn, $sql);
                        echo "<table>";
                        echo "<tr>";
                        echo "<th>TRANSACTION NUMBER</th>";
                        echo "<th>DOCTOR NUMBER</th>";
                        ...
                        if (mysqli_num_rows($result)>0){
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>".$row['Dno']."</td>";
                                echo "<td>".$row['pno']."</td>";
                                echo "<td>".substr($row['Dtime'],0,5)."</td>";
                                echo "</tr>";   
                            }
                        }
                        else{
